...
export default function AddStorageItem() {
  ...
  const { isGetSubCategoriesPending, subcategoriesFromServer } = useSubCategory(
    CategoryId || undefined
  );
  const { isGetProductNamesPending, productNamesFromServer } = useProducts(
    undefined,
    undefined,
  ...
  const selectedProduct =
    selectedProductId !== null && selectedProductId >= 0
  ...
  const isLoading =
    ...
    isGetProductNamesPending ||
    isStorageLocationsPending ||
    createStoredItem.isPending;

  const canSubmit =
    selectedProduct && storageLocationId && quantity > 0 && !isLoading;
        ...
        <CardContent>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <SelectInput
              ...
              onChange={(value) =>
                setSelectedProductId(value === -1 ? null : value)
              }
            />
            ...
            <SelectInput
              ...
              onChange={(value) =>
                setStorageLocationId(value === -1 ? null : value)
              }
            />
