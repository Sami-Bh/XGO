...
namespace testttt
{
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            ImageAnalysisClient client = new ImageAnalysisClient(new Uri(endpoint), new AzureKeyCredential(subscriptionKey));
            using FileStream stream = new FileStream(@"20250921_190512233.MP.jpg", FileMode.Open);
